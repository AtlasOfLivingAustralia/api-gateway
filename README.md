...
Both user and applications will be registered in the [UserDetails](https://github.com/atlasoflivingaustralia/userdetails) app. Roles will be assignable to applications in the same way they are currently assigned to users.
